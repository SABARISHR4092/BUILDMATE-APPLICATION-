    ...
    <div className="h-screen bg-[#F8FAFC] flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
        <div className="bg-[#1E3A8A] p-10 rounded-[24px] mb-8 shadow-lg">
          <ClipboardList className="w-[100px] h-[100px] text-[#EAB308]" strokeWidth={2} />
        </div>
        <h2 className="text-[28px] font-bold mb-4 text-[#1E3A8A]">Detailed Reports</h2>
        <p className="text-gray-600 text-[16px] max-w-[280px] leading-relaxed">
          Generate comprehensive material lists and cost breakdowns with visual charts
        </p>
      </div>
