    ...
    <div className="h-screen bg-[#F8FAFC] flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
        <div className="bg-[#1E3A8A] p-10 rounded-[24px] mb-8 shadow-lg">
          <Calculator className="w-[100px] h-[100px] text-[#EAB308]" strokeWidth={2} />
        </div>
        <h2 className="text-[28px] font-bold mb-4 text-[#1E3A8A]">Accurate Estimation</h2>
        <p className="text-gray-600 text-[16px] max-w-[280px] leading-relaxed">
          Get precise material and cost estimates for your construction projects in minutes
        </p>
      </div>
      ...
      <div className="px-4 pb-8">
        ...
        <button
          ...
          className="w-full text-gray-500 py-4 mt-2 text-[14px]"
        >
          Skip
        </button>
      </div>
